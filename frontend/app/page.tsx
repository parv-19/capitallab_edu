...
const getLandingContent = cache(async () => {
  ...
  const styles = `${extractSection(
    ...
    "<style>",
    "</style>",
  )}\nhtml,body{overflow-y:auto!important;scrollbar-gutter:auto;scrollbar-width:thin}.page{overflow-x:hidden}.page::-webkit-scrollbar,html::-webkit-scrollbar,body::-webkit-scrollbar{width:0;background:transparent}.page::-webkit-scrollbar-track,html::-webkit-scrollbar-track,body::-webkit-scrollbar-track{background:transparent}.page::-webkit-scrollbar-thumb,html::-webkit-scrollbar-thumb,body::-webkit-scrollbar-thumb{background:rgba(148,163,184,.45);border-radius:999px;border:0}.page::-webkit-scrollbar-thumb:hover,html::-webkit-scrollbar-thumb:hover,body::-webkit-scrollbar-thumb:hover{background:rgba(100,116,139,.65)}.nav-links{gap:20px}.nav-links a{display:inline-flex;align-items:center;justify-content:center}.nav-login{margin-left:8px;min-width:92px;border:1px solid rgba(255,255,255,0.36);color:var(--white)!important;padding:8px 18px;border-radius:4px;font-size:14px;font-weight:600;letter-spacing:.3px;line-height:1;transition:background .2s,color .2s,border-color .2s;display:inline-flex;align-items:center;justify-content:center}.nav-login:hover{background:rgba(255,255,255,0.1);color:var(--gold)!important;border-color:rgba(201,168,76,0.55)}.nav-cta{margin-left:2px;min-width:110px;text-align:center}.mobile-login{margin-top:16px;border-radius:4px;font-family:'Source Sans 3',sans-serif!important;font-size:16px!important;font-weight:700!important;width:auto!important;padding:14px 40px!important;color:var(--white)!important;border:1px solid rgba(255,255,255,0.26)}.mobile-login:hover{background:rgba(255,255,255,0.08);color:var(--gold)!important}.mobile-nav{visibility:hidden;pointer-events:none;padding:96px 20px 32px;justify-content:flex-start;overflow-y:auto;-webkit-overflow-scrolling:touch}.mobile-nav.open{visibility:visible;pointer-events:auto}.mobile-nav-close{position:absolute;top:18px;right:16px;z-index:505;display:inline-flex;align-items:center;justify-content:center;width:44px;height:44px;border:1px solid rgba(255,255,255,0.18);border-radius:999px;background:rgba(255,255,255,0.06);color:var(--white);font-size:28px;line-height:1;cursor:pointer;pointer-events:auto;touch-action:manipulation}.mobile-nav-close:hover{background:rgba(255,255,255,0.12);color:var(--gold)}.mobile-nav-logo{pointer-events:none}.hamburger{position:relative;z-index:505;min-width:44px;min-height:44px;align-items:center;pointer-events:auto;touch-action:manipulation}.hamburger span{width:26px}.mobile-nav a{max-width:100%}.testimonial-controls,.testimonial-dots{position:relative;z-index:3}.testimonial-btn,.testimonial-dot{position:relative;z-index:4;pointer-events:auto}.program-accordion-item{position:relative}.program-accordion-trigger{position:relative;z-index:1;pointer-events:auto;touch-action:manipulation}.program-accordion-icon,.program-accordion-icon::before{pointer-events:none}.popup-overlay{pointer-events:none}.popup-overlay.active{pointer-events:auto}`;

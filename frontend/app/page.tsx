...
function transformLandingMarkup(markup: string, testimonials: MarketingTestimonial[]) {
  ...
  return markup
    ...
    .replace(
      ...
      '<form class="contact-form" data-inline-lead-form>',
    )
    .replace(
    ...
    .replace(
      ...
      '<form class="popup-body" data-popup-lead-form>',
    )
    .replace(
      '<p class="popup-skip" id="popupSkip">No thanks, I\'ll explore on my own</p>\n      </div>',
      '<p class="popup-skip" id="popupSkip">No thanks, I\'ll explore on my own</p>\n      </form>',
    )
    .replace(
      '<button class="popup-submit">Send Enquiry &#8594;</button>',
      '<button class="popup-submit" type="submit">Send Enquiry &#8594;</button>',
    )
    .replace(
...
const getLandingContent = cache(async () => {
  ...
  const styles = `${extractSection(
    ...
    "<style>",
    "</style>",
  )}\nhtml,body{overflow-y:auto!important;scrollbar-gutter:auto;scrollbar-width:thin}.page{overflow-x:hidden}.page::-webkit-scrollbar,html::-webkit-scrollbar,body::-webkit-scrollbar{width:0;background:transparent}.page::-webkit-scrollbar-track,html::-webkit-scrollbar-track,body::-webkit-scrollbar-track{background:transparent}.page::-webkit-scrollbar-thumb,html::-webkit-scrollbar-thumb,body::-webkit-scrollbar-thumb{background:rgba(148,163,184,.45);border-radius:999px;border:0}.page::-webkit-scrollbar-thumb:hover,html::-webkit-scrollbar-thumb:hover,body::-webkit-scrollbar-thumb:hover{background:rgba(100,116,139,.65)}.nav-links{gap:20px}.nav-links a{display:inline-flex;align-items:center;justify-content:center}.nav-login{margin-left:8px;min-width:92px;border:1px solid rgba(255,255,255,0.36);color:var(--white)!important;padding:8px 18px;border-radius:4px;font-size:14px;font-weight:600;letter-spacing:.3px;line-height:1;transition:background .2s,color .2s,border-color .2s;display:inline-flex;align-items:center;justify-content:center}.nav-login:hover{background:rgba(255,255,255,0.1);color:var(--gold)!important;border-color:rgba(201,168,76,0.55)}.nav-cta{margin-left:2px;min-width:110px;text-align:center}.mobile-login{margin-top:16px;border-radius:4px;font-family:'Source Sans 3',sans-serif!important;font-size:16px!important;font-weight:700!important;width:auto!important;padding:14px 40px!important;color:var(--white)!important;border:1px solid rgba(255,255,255,0.26)}.mobile-login:hover{background:rgba(255,255,255,0.08);color:var(--gold)!important}.mobile-nav{display:flex!important;visibility:hidden;pointer-events:none;padding:96px 20px 32px;justify-content:flex-start;overflow-y:auto;-webkit-overflow-scrolling:touch}.mobile-nav.open{visibility:visible;pointer-events:auto}.mobile-nav-close{position:absolute;top:18px;right:16px;z-index:10000;display:inline-flex;align-items:center;justify-content:center;min-width:48px;min-height:48px;width:48px;height:48px;border:1px solid rgba(255,255,255,0.18);border-radius:999px;background:rgba(255,255,255,0.06);color:var(--white);font-size:28px;line-height:1;cursor:pointer;pointer-events:auto;touch-action:manipulation}.mobile-nav-close:hover{background:rgba(255,255,255,0.12);color:var(--gold)}.mobile-nav-logo{pointer-events:none}.hamburger{position:relative;z-index:10000;min-width:48px;min-height:48px;pointer-events:auto;touch-action:manipulation}.hamburger span{width:26px;pointer-events:none}.hero::before,.hero::after,.program-hero::before,.program-hero::after{pointer-events:none}.contact-form,.popup-body{position:relative;pointer-events:auto;z-index:10000}.mobile-nav a{max-width:100%}.testimonial-controls,.testimonial-dots{position:relative;z-index:5}.testimonial-btn,.testimonial-dot{position:relative;z-index:6;pointer-events:auto;touch-action:manipulation}.program-accordion-item{position:relative}.program-accordion-trigger{position:relative;z-index:1;pointer-events:auto;touch-action:manipulation}.program-accordion-icon,.program-accordion-icon::before{pointer-events:none}.submit-btn,.popup-submit{position:relative;pointer-events:auto;touch-action:manipulation;z-index:10000;min-height:44px}.popup-overlay{pointer-events:none}.popup-overlay.active{pointer-events:auto}@media (max-width:768px){.contact-form{padding-bottom:96px}.contact-form .submit-btn{margin-bottom:0}}`;

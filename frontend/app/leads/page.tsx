...
.leads-menu-btn{display:none;border:none;background:transparent;padding:6px;flex-direction:column;gap:5px;cursor:pointer}
...
.leads-mobile-nav{position:fixed;inset:0;background:rgba(13,27,62,.98);z-index:300;opacity:0;pointer-events:none;transform:translateX(100%);transition:transform .25s ease,opacity .25s ease;padding:22px 18px}
...
.leads-mobile-nav__close{border:none;background:transparent;color:#fff;font-size:34px;line-height:1;cursor:pointer}
...
.testi-grid.testi-carousel-track .testi-card{min-width:calc(33.333% - 14px);flex:0 0 calc(33.333% - 14px)}
...
@media (max-width: 900px){.leads-menu-btn{display:flex}.testi-grid.testi-carousel-track .testi-card{min-width:100%;flex:0 0 100%}}

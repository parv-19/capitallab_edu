...
import { GraduationCap, Instagram, Youtube, Linkedin, Phone, Mail, MapPin } from "lucide-react";
    ...
    <footer className="bg-brand-navyDark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-5">
              Ahmedabad&apos;s premier offline coaching institute — shaping futures with expert faculty, proven results, and personal attention.
            </p>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <p className="text-white/60 text-sm">Mon – Sat: 9:00 AM – 7:00 PM</p>
              <p className="text-white/60 text-sm">Sunday: 10:00 AM – 2:00 PM</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-white/60">
                ...
                <span>123, Capital House, Near Law Garden,<br />Ahmedabad – 380006, Gujarat</span>
              </li>
              ...
              <li className="flex items-center gap-3 text-sm text-white/60">
                ...
                <a href="mailto:info@capitallabedu.com" className="hover:text-brand-gold transition-colors">info@capitallabedu.com</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-shell py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/40">
          <span>© 2026 Capital Lab Education. All rights reserved.</span>
